...
<div className="border-4 border-red-500 w-1/2 h-[100vh]">
  ...
  <div className="flex flex-col justify-center items-start  ">
    ...
    <p className="text-gray-600 text-2xl font-semibold">backface helps you connect and share with people in your life</p>
  </div>
</div>
...
<Input  value={value.email} handleChange={handleChange} placeholder={'Email adress or phone number'} name={'email'} type={'text'} />
<Input  value={value.password} handleChange={handleChange} placeholder={'Password'} name={'login'} type={'text'} />
<button className="text-white font-bold bg-blue-500 w-full rounded-md p-2 text-xl hover:bg-blue-600">Log in</button>
<p className="text-md  text-blue-500 hover:underline cursor-pointer">Forgotten password?</p>
<div className='h-[2px] w-full bg-[#E3E3E3] '/>
<button className="capitalize text-white font-bold text-xl p-2 rounded-md bg-green-500 hover:bg-green-600" onClick={()=>setTogleLogin(true)} >create new account</button>
</div>
...
{
  togleLogin&&(
    <motion.div className="absolute opacity-0 bg-red-500 w-screen h-screen z-10 backdrop-blur flex justify-center items-center"
