  ...
  return (
    <section className='w-full max-h-[280px] overflow-auto vertical_scroll '>
      <textarea
        ...
        className='outline-none w-full cursor-pointer   mt-2 mb-2 placeholder:text-2xl dark:bg-darkSecondary pt-2 pl-2 dark:text-white placeholder:text-gray-500 placeholder:capitalize font-meduim overflow-hidden resize-none'
      />
    </section>
  )
}
