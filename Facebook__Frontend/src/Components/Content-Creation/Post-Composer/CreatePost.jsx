...
import { UserProfileImage } from '../../Miscellaneous/module';
import { PostCreationLinks, FileUploader, PostAudienceIcon } from '../module';
          ...
          <section className='w-fit flex flex-col items-start gap-2'>
            ...
            >
              <article className='text-sm text-gray-900   dark:text-white'>
                <PostAudienceIcon state={audState} />
              </article>
