...
const SideBar = () => {
  const barHarder =
    ' text-black dark:text-text_heading_dark_white hidden larg:block text-lg font-medium'
  const barContainer =
    ...
    <div className='flex flex-col justify-start items-baseline larg:w-full h-fit pb-2 pl-2'>
      ...
      {sideLinks.map((page, i) => (
        ...
        >
          ...
          <p className='text-lg text-gray-800 font-medium dark:text-text_heading_dark_white hidden larg:block'>
            {page.title}
          </p>
