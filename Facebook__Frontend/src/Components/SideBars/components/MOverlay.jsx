...
const MOverlay = () => {
  ...
  return (
    <section className='h-screen w-screen absolute z-40 top-0 right-0 dark:bg-dark500 bg-light400 overflow-auto scroll-hidden'>
      ...
      <section>
        <Profile size link='/backface/api/profile' />
      </section>
        ...
        <section className='w-full flex flex-col gap-1 mt-4 pl-2 pr-2'>
          ...
          {[
            ...
            <div
              ...
              key={i + title}
              className={`  ${title} dark:bg-dark300 hover:bg-light300 p-2 w-full rounded-md cursor-pointer`}
            >
          ...
          {[
            ...
            >
              ...
              <div className=''>
                ...
                {options.map((items, i) => (
                  <button
                    className={` ${items.class} mt-2.5 mb-2.5 w-full cursor-pointer dark:bg-dark300 hover:bg-light500 p-2 rounded-md`}
                    key={i}
                    ref={items.ref}
                    onClick={() => {
