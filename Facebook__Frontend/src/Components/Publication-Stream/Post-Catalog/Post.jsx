...
import { CommentsSection, CommentButton } from '../../Feedback-Panel/module';
  ...
  return (
    <section className='dark:border dark:border-bd500 dark:bg-dark400 md:order-3 flex flex-col rounded-md bg-white drop-shadow-xl shadow-xl mt-4'>
      ...
      <Redirect link={`/post/details/photo?fbid=${_id}`}>
        <PostMediaLayout post={postfile} postlength={postfile?.length} />
      </Redirect>
      <section className='flex flex-col '>
        ...
        >
          ...
          <CommentButton setIsComment={setIsComment} isComment={isComment} />
          <Share />
        </section>
        <CommentsSection
          postDetail
